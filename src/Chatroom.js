...
class Chatroom extends React.Component {
    ...
    submitMessage(e) {
        e.preventDefault();
        if(ReactDOM.findDOMNode(this.refs.msg).value == '') return;
        this.setState({
    ...
    render() {
        ...
        return (
            <div className="chatroom">
                ...
                {this.state.isType ? <span id="typing">{username} is typing </span> : ''}
                <form className="input" onSubmit={(e) => this.submitMessage(e)}>
                    <input type="text" ref="msg" onFocus={(e) => this.setType(e,true)} onBlur={(e) => this.setType(e,false)}/>
